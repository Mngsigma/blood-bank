...
<div class="container-fluid"style='background-color:green;'>
  ...
  <ul class="navbar-nav" >
    <li class="nav-item">
      <a style='color:white;' class="nav-link" href="addproduct.php">Add Product</a>
    </li>
    <li class="nav-item">
      <a style='color:white;' class="nav-link" href="patientlogin.php">Login</a>
    </li>
    <li class="nav-item">
      <a style='color:white;' class="nav-link" href="registration.php">Registration</a>
    </li>
    <li class="nav-item">
        <a style='color:white;' class="nav-link" href="editproduct.php">Edit Product</a>
      </li>
      <li class="nav-item">
        <a style='color:white;' class="nav-link" href="logout.html">Logout</a>
      </li>
      <li class="nav-item">
        <a style='color:white;' class="nav-link" href="Admin.php">Admin Home</a>
      </li>
  </ul>
</div>
...
<form method='POST'> 
      ...
      Patient Name: <br><input type='text'  name='t1' style='width: 60%;' class='form-control'> 
...
<?php
    ...
    { 
      ...
      $j="insert into patients values('$a','$b','$c','$d','$e')";
