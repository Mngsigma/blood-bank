...
<form method='POST'> <a href="donorsreg.php">Register</a> <br>
      Donoar Id: <br><input type='text' value='' name='t0' style='width: 60%; '  class='form-control'>
...
<?php
    ...
    { 
      ...
      $j="select * from donors where id='$a' and password='$d'";
      $rs=mysqli_query($con,$j);
             
            if($row=mysqli_fetch_array($rs))
            {  session_start();
                $_SESSION['d_id']=$_POST['t0'];
         echo"<script>window.location='donardash.php'</script>";
         }
         else
         {
