    ...
    <nav class="navbar navbar-expand-sm bg-light">
      ...
      <a class="navbar-brand" style="color:white"; href="#">BlooD DekhO Ji</a>
          ...
          <ul class="navbar-nav" >
            ...
            <li class="nav-item">
              <a style='color:white;' class="nav-link" href="adminlogin.php">Admin</a>
            </li>
            <li class="nav-item">
              <a style='color:white;' class="nav-link" href="donorslogin.php">Donor</a>
            </li>
            <li class="nav-item">
                <a style='color:white;' class="nav-link" href="patientlogin.php">Patient</a>
              </li>
              <li class="nav-item">
...
<div id="demo" class="carousel slide" style="margin-top:-10px"; data-bs-ride="carousel">
...
<img src="image_downloader_1712398107658.jpg.webp" style="width:100%; height=100px;"; alt="">
</div>
