...
<div class="container-fluid"style='background-color:green;'>
  ...
  <li class="nav-item">
    ...
    <li class="nav-item">
      <a style='color:white;' class="nav-link" href="donardash.php">Donor Dashboard</a>
    </li>
    <li class="nav-item">
...
<form method='POST'> 
      Donor Blood Group: <br> <select name="t0" class='form-select' style='width:60%'; id="">
      ...
      Units: <br><input type='text'  name='t1' style='width: 60%;' class='form-control'> 
       Disease if any ? <br><input type='text' name='t2' style='width: 60%; height:70px; ' class='form-control'> 
        <br>  <input type='submit' value='Submit' style='width:60%;' class='btn btn-success'>
       </form>

       <?php
         session_start();
         if(isset($_SESSION['d_id'])==false)
         {
...
$d_id=$_SESSION['d_id'];
    ...
    { 
      ...
      $j="insert into donation values('$d_id','$a','$b','$c','$d')";
      $rs=mysqli_query($con,$j);
      if($rs)
      {
         echo"<br><h1> Donation go for ADMIN approve...!!</h1>";
      }
      else
      {
